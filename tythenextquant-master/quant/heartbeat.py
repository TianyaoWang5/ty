...
class HeartBeat(object):
    ...
    def alive(self):
        ...
        try:
            ...
            res=requests.post("http://"+ipaddress+":"+port+"/fet_client_time/",data=data,headers=headers)
            logger.info("res:", res.text, caller=self)
        except Exception as err:
            logger.info("err:", err, caller=self)
